...
import { FormConfig, FieldConfig, FormSubmissionResult, ApiResponse } from '../types/api';
...
export function useDynamicForm({ 
  ...
  const evaluateCondition = useCallback((field: FieldConfig): boolean => {
  ...
  const getVisibleFields = useCallback((fields: FieldConfig[]): FieldConfig[] => {
