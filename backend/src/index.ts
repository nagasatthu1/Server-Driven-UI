...
app
  ...
  .get('/api/config/sidebar-menu', () => [
    ...
    { icon: 'FolderOpen', label: 'Phòng ban', path: '/departments' },
    { icon: 'Users', label: 'Thông tin người dùng', path: '/users' },
        ...
        widgets: [
          {
            ...
            items: ['Form đăng ký', 'Form liên hệ', 'Form khảo sát'],
          },
        ],
      },
      '/examples': {
        ...
        widgets: [
          {
            type: 'components',
            title: 'UI Components',
            items: ['Input', 'Button', 'Modal', 'Table', 'Chart'],
          },
        ],
      },
      '/users': {
        ...
        widgets: [
          {
            type: 'list',
            title: 'Tin nhắn mới',
            items: ['Tin nhắn 1', 'Tin nhắn 2', 'Tin nhắn 3'],
          },
        ],
      },
      '/documents': {
